...
global $woocommerce; ?>
<div class="top-form top-form-minicart emarket-minicart6 <?php echo( (string)get_option('layout_style') ) ; ?> pull-right">
		...
		<div class="minicart-padding">
						...
						<div class="detail-item">
							<div class="product-details"> 
								...
								<div class="product-action clearfix">
									<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="btn-remove" title="%s"><span class="fa fa-trash-o"></span>%s</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_attr__( 'Remove this item', 'emarket' ), esc_html__( 'Remove', 'emarket' ) ), $cart_item_key ); ?>           
			...
			<div class="cart-checkout">
				...
				<div class="cart-links clearfix">
					...
					<div class="checkout-link"><a href="<?php echo get_permalink(get_option('woocommerce_checkout_page_id')); ?>" title="<?php esc_attr_e( 'Checkout', 'emarket' ) ?>"><?php esc_html_e('Checkout', 'emarket'); ?></a></div>
				</div>
			</div>
		</div>
	</div>
