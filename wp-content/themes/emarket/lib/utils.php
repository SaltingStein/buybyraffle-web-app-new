...
?>
	<div class="social-share">
		...
		<div class="wrap-content">
			<!-- Facebook share -->
			<?php if( emarket_options()->getCpanelValue('fb_share') ) { ?>
			...
			<!-- Twitter Share -->
			<?php if( emarket_options()->getCpanelValue('tw_share') ) { ?>
			...
			<!-- Reddit Share -->
			<?php if( emarket_options()->getCpanelValue('reddit_share') ) { ?>
			<div class="item-social reddit">
				<a href="http://reddit.com/submit?url=<?php echo get_permalink( $post->ID ); ?>&title=<?php echo get_the_title( $post->ID ); ?>" target="_blank"><i class="fa fa-reddit"></i></a>
			</div>
			<?php } ?>
			
			<!-- Linkedin Share -->
			<?php if( emarket_options()->getCpanelValue('linkedin_share') ) { ?>
			<div class="item-social linkedin">
				<a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo get_permalink( $post->ID ); ?>" target="_blank"><i class="fa fa-linkedin"></i></a>
			</div>
			<?php } ?>
			
			<!-- Pinterest Share -->
			<?php if( emarket_options()->getCpanelValue('pinterest_share') ) { ?>
			...
			<!-- Tumblr Share -->
			<?php if( emarket_options()->getCpanelValue('tumblr_share') ) { ?>
			<div class="item-social tumblr">
				<a href="http://www.tumblr.com/share/link?url=<?php echo get_permalink( $post->ID ); ?>&amp;title=<?php echo get_the_title( $post->ID ); ?>" target="_blank"><i class="fa fa-tumblr"></i></a>
			</div>	
			<?php } ?>
		</div>
	</div>
