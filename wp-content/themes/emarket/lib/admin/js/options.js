jQuery(document).ready(function(){	
	...
	jQuery('input[name="'+emarket_opts.opt_name+'[defaults]"]').on('click',function(){
		if(!confirm(emarket_opts.reset_confirm)){
			return false;
		}
	});
	
	jQuery('.emarket-opts-group-tab-link-a').on('click',function(){
	...
	jQuery('#emarket-opts-import-code-button').on('click',function(){
	...
	jQuery('#emarket-opts-import-link-button').on('click',function(){
	...
	jQuery('#emarket-opts-export-code-copy').on('click',function(){
	...
	jQuery('#emarket-opts-export-link').on('click',function(){
	...
	jQuery(".emarket-single-select").each( function(){
		var placehold = jQuery(this).data( 'placehold' );
		jQuery(this).select2({
